#ifndef EVOLIS_Z390_LITHOGRAPHPRINTER_H
#define EVOLIS_Z390_LITHOGRAPHPRINTER_H

#include "Evolis_Z390_LithographPrinter_global.h"
#include "LithographPrinter.h"
#include "./decard/BasicOper.h"
#include "./decard/dcrf32.h"
#include <string>
#include <vector>
#include <memory>
//#include <QVector>
...
class EVOLIS_Z390_LITHOGRAPHPRINTER_EXPORT Evolis_Z390_LithographPrinter:public CLithographPrinter
{
public:
    Evolis_Z390_LithographPrinter(void);
    virtual ~Evolis_Z390_LithographPrinter(void);
    /** @ingroup CLithographPrinter Function declaration
        ...
        bool WriteFile(DEVHANDLE dcHandle, string fileID, string tag, string val, char* pszRcCode,string &strOutmsg);
        bool WriteCA(DEVHANDLE dcHandle, string fileID, string tag, string val, char* pszRcCode,string &strOutmsg);
...
//#define RunlogF(...)       fprintf(stderr,__VA_ARGS__);
        void Runlog(const char* pFunction,int nLine, const char* __fmt, ...);
        const char* getPlatformABI();
    private:
        void    *m_pPrinter = nullptr;
        void    *m_pAndroidContext = nullptr;
        int     m_hReader = 0;
		string  CardATR;
		CARDINFO m_CardInfo;
...
#endif // EVOLIS_Z390_LITHOGRAPHPRINTER_H
